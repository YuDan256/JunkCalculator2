...
int jc2_init(jc2::Module& mod) {
    ...
    g_tensorClass->bind_method("__add__", tensor___add__, 1, 1, false, {"other"});
    g_tensorClass->bind_method("__radd__", tensor___radd__, 1, 1, false, {"other"});
    g_tensorClass->bind_method("__sub__", tensor___sub__, 1, 1, false, {"other"});
    g_tensorClass->bind_method("__rsub__", tensor___rsub__, 1, 1, false, {"other"});
    g_tensorClass->bind_method("__mul__", tensor___mul__, 1, 1, false, {"other"});
    g_tensorClass->bind_method("__rmul__", tensor___rmul__, 1, 1, false, {"other"});
    g_tensorClass->bind_method("__div__", tensor___div__, 1, 1, false, {"other"});
    g_tensorClass->bind_method("__rdiv__", tensor___rdiv__, 1, 1, false, {"other"});
    ...
    g_tensorClass->bind_method("to", tensor_to, 1, 1, false, {"dtype"});
    g_tensorClass->bind_method("clone", tensor_clone, 0, 0, false);
    g_tensorClass->bind_method("contiguous", tensor_contiguous, 0, 0, false);
    g_tensorClass->bind_method("view", tensor_view, 1, 1, false, {"shape"});
    g_tensorClass->bind_method("reshape", tensor_reshape, 1, 1, false, {"shape"});
    g_tensorClass->bind_method("T", tensor_T, 0, 0, false);
    g_tensorClass->bind_method("transpose", tensor_transpose, 2, 2, false, {"dim0", "dim1"});
    ...
    g_tensorClass->bind_method("softmax", tensor_softmax, 0, 1, false, {"axis"});
    g_tensorClass->bind_method("matmul", tensor_matmul, 1, 1, false, {"other"});
    ...
    g_tensorClass->bind_method("getFlat", tensor_getFlat, 1, 1, false, {"idx"});
    g_tensorClass->bind_method("setFlat", tensor_setFlat, 2, 2, false, {"idx", "val"});
    ...
    mod.register_function("full", global_full, 2, 4, false, {"shape", "val", "dtype", "requires_grad"});
    mod.register_function("eye", global_eye, 1, 2, false, {"n", "dtype"});
    mod.register_function("arange", global_arange, 2, 4, false, {"start", "end", "step", "dtype"});
    mod.register_function("linspace", global_linspace, 3, 4, false, {"start", "end", "steps", "dtype"});
    mod.register_function("rand", global_rand, 1, 3, false, {"shape", "dtype", "requires_grad"});
    mod.register_function("randn", global_randn, 1, 3, false, {"shape", "dtype", "requires_grad"});
    mod.register_function("matmul", global_matmul, 2, 2, false, {"a", "b"});
    mod.register_function("cat", global_cat, 1, 2, false, {"tensors", "axis"});
    mod.register_function("stack", global_stack, 1, 2, false, {"tensors", "axis"});
    mod.register_function("mse_loss", global_mse_loss, 2, 2, false, {"pred", "target"});
    mod.register_function("softmax", global_softmax, 1, 2, false, {"t", "axis"});
    mod.register_function("backward", global_backward, 1, 1, false, {"t"});
    mod.register_function("zero_grad", global_zero_grad, 1, 1, false, {"t"});
    mod.register_function("sgd_step", global_sgd_step, 2, 2, false, {"param", "lr"});
    mod.register_function("isTensor", global_isTensor, 1, 1, false, {"val"});
    mod.register_function("to", global_to, 2, 2, false, {"t", "dtype"});
    mod.register_function("getrow", global_getrow, 2, 2, false, {"t", "row"});
    mod.register_function("getcol", global_getcol, 2, 2, false, {"t", "col"});
    mod.register_function("deleterow", global_deleterow, 2, 2, false, {"t", "row"});
    mod.register_function("deletecol", global_deletecol, 2, 2, false, {"t", "col"});
    mod.register_function("swaprows", global_swaprows, 3, 3, false, {"t", "r1", "r2"});
    mod.register_function("hstack", global_hstack, 1, 1, false, {"tensors"});
    mod.register_function("vstack", global_vstack, 1, 1, false, {"tensors"});
    mod.register_function("from_matrix", global_from_matrix, 1, 2, false, {"mat", "requires_grad"});
    mod.register_function("to_matrix", global_to_matrix, 1, 1, false, {"t"});
    mod.register_function("no_grad", global_no_grad, 1, 1, false, {"fn"});
