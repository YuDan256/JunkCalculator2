...
namespace jc {
    ...
    enum class ObjType {
        STRING, BIGINT, FRACTION, COMPLEX,
    ...
    enum class BuiltinType : int8_t {
        UNKNOWN = -1,
        ANY, INT, FLOAT, STRING, BOOL, NONE_TYPE,
        LIST, DICT, SET, FRACTION, COMPLEX, SYMBOLIC,
        REALMAT, COMPLEXMAT, SYMMAT, FUNC, CLASS, INSTANCE, NAMESPACE,
